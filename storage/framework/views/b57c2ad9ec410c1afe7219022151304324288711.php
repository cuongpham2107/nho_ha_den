...
<div class="container-fluid" id="c8" style="background: url(<?php echo e(Voyager::image($achievement->image)); ?>) no-repeat center;">
  <div class="container">
          ...
          <?php $__currentLoopData = $partners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $partner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="item <?php if($loop->first): ?> active <?php endif; ?>">
              <div class="col-lg-4 col-md-4 col-xs-4">
                <a href="#">
                  <img src="<?php echo e(Voyager::image($partner->image)); ?>" class="img-responsive" alt="<?php echo e($partner->title); ?>" loading="lazy">
                </a>
              </div>
            </div>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('frontend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/anphuong/domains/anphuong.kennatech.vn/public_html/resources/views/frontend/homepage/index.blade.php ENDPATH**/ ?>