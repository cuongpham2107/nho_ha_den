<?php $__env->startSection('style'); ?>
  ...
  <link rel='stylesheet' id='elementor-post-502-css'
    href='<?php echo e(asset('assets/uploads/sites/168/elementor/css/post-5023597.css?ver=1653499804')); ?>' type='text/css' media='all' />
            ...
            <div class="elementor-element elementor-element-8bb3270 elementor-widget elementor-widget-jkit_post_title"
              ...
              <div class="elementor-widget-container">
                <div class="jeg-elementor-kit jkit-post-title jeg_module_502_1_62bbb3aa51613">
                  <h2 class="post-title style-color "><?php echo e($page->title); ?></h2>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="elementor-widget-container">
                <div class="jeg-elementor-kit jkit-post-date jeg_module_502_3_62bbb3aa55b61"><span
                    class="post-date "><?php echo e(date('F d, Y', strtotime($page->created_at))); ?></span></div>
              </div>
            </div>
          </div>
        </div>
              ...
              <div class="elementor-widget-container">
                <div class="jeg-elementor-kit jkit-post-featured-image jeg_module_502_4_62bbb3aa57be2">
                  <div class="post-featured-image "><img loading="lazy" width="2000" height="1333"
                      src="<?php echo e(Voyager::image($page->image)); ?>"
                      class="attachment-full size-full wp-post-image" alt="<?php echo e($page->title); ?>">
                    </div>
                </div>
              </div>
            </div>
                ...
                <div
                  ...
                  <div class="elementor-widget-wrap elementor-element-populated">
                    <div class="elementor-element elementor-element-3ba65e7 elementor-widget elementor-widget-heading"
                      ...
                      <div class="elementor-widget-container">
                        <h5 class="elementor-heading-title elementor-size-default">Chia sẻ :
                        </h5>
                      </div>
                    </div>
                    <div
                        ...
                        <div class="jeg-elementor-kit jkit-social-share jeg_module_502_6_62bbb3aa64be5">
                          <ul class="social-share-list">
                            <li class="elementor-repeater-item-d872905" data-social="facebook">
                              <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(url()->current()); ?>" target="_blank" class="facebook social-icon"><i aria-hidden="true" class="fab fa-facebook-f"></i></a>
                            </li>
                            <li class="elementor-repeater-item-642a6cf" data-social="twitter">
                              <a href="https://twitter.com/share?url=<?php echo e(url()->current()); ?>" target="_blank" class="twitter social-icon"><i aria-hidden="true" class="fab fa-twitter"></i></a>
                            </li>
                            <li class="elementor-repeater-item-3830110" data-social="linkedin">
                              <a href="https://www.linkedin.com/shareArticle?url=<?php echo e(url()->current()); ?>" target="_blank" class="linkedin social-icon"><i aria-hidden="true" class="fab fa-linkedin-in"></i></a>
                            </li>
                          </ul>
                        </div>
                      </div>
...
<?php echo $__env->make('frontend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cathinh/domains/cathinh.kennatech.vn/public_html/resources/views/frontend/pages/index.blade.php ENDPATH**/ ?>