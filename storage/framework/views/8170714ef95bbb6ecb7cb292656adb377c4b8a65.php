<?php $__env->startSection('style'); ?>
  ...
  <link rel='stylesheet' id='elementor-post-744-css'
    href='<?php echo e(asset('assets/uploads/sites/168/elementor/css/post-7441f32.css?ver=1653523944')); ?>' type='text/css' media='all' />
  ...
  <link rel='stylesheet' id='elementor-post-773-css'
    href='<?php echo e(asset('assets/uploads/sites/168/elementor/css/post-7731f32.css?ver=1653523944')); ?>' type='text/css' media='all' />
  <link rel='stylesheet' id='metform-ui-css'
		href='<?php echo e(asset('assets/plugins/metform/public/assets/css/metform-ui784e.css?ver=2.1.6')); ?>' type='text/css' media='all' />
	<link rel='stylesheet' id='metform-style-css'
		href='<?php echo e(asset('assets/plugins/metform/public/assets/css/style784e.css?ver=2.1.6')); ?>' type='text/css' media='all' />
  <style>
...
<?php $__env->startSection('content'); ?>
  <div data-elementor-type="wp-page" data-elementor-id="744" class="elementor elementor-744">
    ...
    <section
      ...
      data-settings="{&quot;background_background&quot;:&quot;classic&quot;}"
      style="background-image: url(<?php echo e(Voyager::image($contact->image ?? '')); ?>)">
      <div class="elementor-background-overlay"></div>
      <div class="elementor-container elementor-column-gap-no">
                        ...
                        <div
                          ...
                          <div class="jkit-icon-box-wrapper hover-from-left">
                            <div class="icon-box icon-box-body">
                              ...
                              <p class="icon-box-description"><?php echo e(setting('site.description')); ?></p>
                            </div>
                        ...
                        <div
                          ...
                          <div class="jkit-icon-box-wrapper hover-from-left">
                            <div class="icon-box icon-box-body">
                              ...
                              <p class="icon-box-description"><?php echo e(setting('site.phone')); ?></p>
                            </div>
                            ...
                            <div class="icon-box icon-box-body">
                              ...
                              <p class="icon-box-description">
                                <a href="mailto:<?php echo e(setting('site.email')); ?>"
                                  class="__cf_email__"><?php echo e(setting('site.email')); ?></a>
                              </p>
                            </div>
                                          ...
                                          <div
                                            ...
                                            <div class="elementor-widget-wrap elementor-element-populated">
                                              ...
                                              <div
                                                ...
                                                <div class="elementor-widget-container">
                                                  <p><?php echo e($contact->excerpt ?? ''); ?></p>
                                                </div>
                                              </div>
                                              <section
                                                      ...
                                                      <div
                                                        ...
                                                        <div class="elementor-widget-container">
                                                          <div class="mf-input-wrapper">
                                                            <input type="text"
                                                              class="mf-input <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>" id="mf-input-text-42b6091"
                                                              name="name" placeholder="Tên bạn" value="<?php echo e(request()->name ?? ''); ?>"
                                                              aria-invalid="false" >
                                                    ...
                                                    <div class="elementor-widget-wrap elementor-element-populated">
                                                      <div
                                                        ...
                                                        <div class="elementor-widget-container">
                                                          <div class="mf-input-wrapper">
                                                            <input type="email"
                                                              class="mf-input <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="mf-input-email-4eb0fe2"
                                                              name="email" placeholder="Email" value="<?php echo e(request()->email ?? ''); ?>"
                                                              aria-invalid="false">
                                                    ...
                                                    <div class="elementor-widget-wrap elementor-element-populated">
                                                      <div
                                                        ...
                                                        <div class="elementor-widget-container">
                                                          <div class="mf-input-wrapper">
                                                            <input type="tel"
                                                              class="mf-input <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="mf-input-telephone-6cd8879"
                                                              name="phone" placeholder="Điện thoại" value="<?php echo e(request()->phone ?? ''); ?>"
                                                              aria-invalid="false">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cathinh/domains/cathinh.kennatech.vn/public_html/resources/views/frontend/contact/index.blade.php ENDPATH**/ ?>