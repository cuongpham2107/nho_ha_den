            ...
            <div class="elementor-element elementor-element-8bb3270 elementor-widget elementor-widget-jkit_post_title"
              ...
              <div class="elementor-widget-container">
                <div class="jeg-elementor-kit jkit-post-title jeg_module_502_1_62bbb3aa51613">
                  <h2 class="post-title style-color "><?php echo e($post->title); ?></h2>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div class="elementor-widget-container">
                <div class="jeg-elementor-kit jkit-post-date jeg_module_502_3_62bbb3aa55b61"><span
                    class="post-date "><?php echo e(date('F d, Y', strtotime($post->created_at))); ?></span></div>
              </div>
            </div>
          </div>
        </div>
              ...
              <div class="elementor-widget-container">
                <div class="jeg-elementor-kit jkit-post-featured-image jeg_module_502_4_62bbb3aa57be2">
                  <div class="post-featured-image "><img loading="lazy" width="2000" height="1333"
                      ...
                      class="attachment-full size-full wp-post-image" alt="<?php echo e($post->title); ?>">
                    </div>
                </div>
              </div>
            </div>
...
<?php echo $__env->make('frontend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cathinh/domains/cathinh.kennatech.vn/public_html/resources/views/frontend/work/show.blade.php ENDPATH**/ ?>