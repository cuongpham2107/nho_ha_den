<script defer src="<?php echo e(asset('js/alpinejs@3.10.2.min.js')); ?>"></script>
  ...
  document.addEventListener('alpine:init', () => {
    Alpine.data('alert', () => ({
      ...
      init() {
        ...
        let alert = JSON.parse(`<?php echo json_encode(session()->get('alert'), 15, 512) ?>`)
...
<?php /**PATH /home/cathinh/domains/cathinh.kennatech.vn/public_html/resources/views/frontend/layouts/partials/alert.blade.php ENDPATH**/ ?>