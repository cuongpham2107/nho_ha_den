  ...
  <div class="container" style="padding: .5rem 2rem;">
    ...
    <div>
      <ul class="phone">
        ...
        <li><span class="fa fa-phone"></span><?php echo e(setting('site.phone')); ?></li>
      </ul>
    </div>
  </div>
      ...
      <nav class="navbar navbar-default">
        <div class="container-fluid" style="padding: 0;">
          ...
          <div class="navbar-header">
            <a href="<?php echo e(asset('/')); ?>" class="mobile-logo">
              <img src="<?php echo e(\TCG\Voyager\Facades\Voyager::image(setting('site.logo'))); ?>" alt="<?php echo e(setting('site.title')); ?>" style="filter: brightness(0) invert(1);" loading="lazy"/>
            </a>
...
</header><?php /**PATH /home/anphuong/domains/anphuong.kennatech.vn/public_html/resources/views/frontend/layouts/partials/header.blade.php ENDPATH**/ ?>