...
<link rel='stylesheet' id='elementor-post-864-css'
  href='{{ asset('assets/uploads/sites/168/elementor/css/post-864ff49.css?ver=1653884335') }}' type='text/css' media='all' />
@endsection
      ...
      <div
        ...
        <div class="elementor-widget-wrap elementor-element-populated">
          ...
          <div class="elementor-element elementor-element-06811e5 elementor-widget elementor-widget-heading"
            ...
            <div class="elementor-widget-container">
              <h2 class="elementor-heading-title elementor-size-default">{{$banner->title ?? 'Không tìm thấy trang'}}</h2>
            </div>
          </div>
          <div
          ...
          <div class="elementor-element elementor-element-e733da6 elementor-widget elementor-widget-text-editor"
            ...
            <div class="elementor-widget-container">
              ...
              {{$banner->description ?? 'Trang bạn đang tìm không tồn tại'}}
            </div>
          </div>
          <div
            ...
            <div class="elementor-widget-container">
              <div class="elementor-button-wrapper">
                <a href="{{route('index')}}" class="elementor-button-link elementor-button elementor-size-sm" role="button">
