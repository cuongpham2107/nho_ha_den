...
@section('content')
  ...
  <div data-elementor-type="wp-page" data-elementor-id="7" class="elementor elementor-7">
    ...
    <section
      ...
      <div class="elementor-container elementor-column-gap-no">
        <div class="elementor-column elementor-col-33 elementor-top-column elementor-element elementor-element-309ccd2"
          ...
          <div class="elementor-widget-wrap elementor-element-populated"
            style="background-image: url({{ Voyager::image($page1->image) }});">
            <div class="elementor-background-overlay"></div>
            ...
            <div class="elementor-element elementor-element-9f0bff5 elementor-widget elementor-widget-heading"
              ...
              <div class="elementor-widget-container">
                <h2 class="elementor-heading-title elementor-size-default">{{ $page1->title }}</h2>
              </div>
            </div>
            <div
              ...
              <div class="elementor-widget-container">
                <div class="elementor-button-wrapper">
                  <a href="{{ route('pages.show', $page1->slug) }}" class="elementor-button-link elementor-button elementor-size-sm" role="button">
                    <span class="elementor-button-content-wrapper">
        ...
        <div class="elementor-column elementor-col-33 elementor-top-column elementor-element elementor-element-2a6f942"
          ...
          data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
          <div class="elementor-widget-wrap elementor-element-populated"
            style="background-image: url({{ Voyager::image($page2->image) }});">
            <div class="elementor-background-overlay"></div>
            ...
            <div class="elementor-element elementor-element-0f7eab9 elementor-widget elementor-widget-heading"
              ...
              <div class="elementor-widget-container">
                <h2 class="elementor-heading-title elementor-size-default">{{ $page2->title }}</h2>
              </div>
            </div>
            <div
              ...
              <div class="elementor-widget-container">
                <div class="elementor-button-wrapper">
                  <a href="{{ route('pages.show', $page2->slug) }}" class="elementor-button-link elementor-button elementor-size-sm" role="button">
                    <span class="elementor-button-content-wrapper">
                      <span class="elementor-button-text">Xem thêm</span>
                    </span>
                  </a>
        ...
        <div class="elementor-column elementor-col-33 elementor-top-column elementor-element elementor-element-5c34ede"
          ...
          data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
          <div class="elementor-widget-wrap elementor-element-populated"
            style="background-image: url({{ Voyager::image($page3->image) }});">
            <div class="elementor-background-overlay"></div>
            ...
            <div class="elementor-element elementor-element-e422702 elementor-widget elementor-widget-heading"
              ...
              <div class="elementor-widget-container">
                <h2 class="elementor-heading-title elementor-size-default">{{ $page3->title }}</h2>
              </div>
            </div>
            <div
              ...
              <div class="elementor-widget-container">
                <div class="elementor-button-wrapper">
                  <a href="{{ route('pages.show', $page3->slug) }}" class="elementor-button-link elementor-button elementor-size-sm" role="button">
                    <span class="elementor-button-content-wrapper">
                      <span class="elementor-button-text">Xem thêm</span>
                    </span>
                  </a>
                          ...
                          <div class=fun-fact-inner>
                            ...
                            <div class="content">
                              <div class="number-wrapper">
                                <span class="number" data-value="{{ setting('site.experience') }}" data-animation-duration="3500">0</span>
                                <sup class="super">+</sup>
                              </div>
                  ...
                  <div class="progress-group ">
                    <div class="progress-skill-bar">
                      <div class="skill-bar-content"><span class="skill-title">
                          Chất lượng Cá Thính</span></div>
                      <div class="skill-bar">
                        <div class="skill-track">

                          <div class="number-percentage-wrapper">
                            <span class="number-percentage" data-value="{{setting('site.quality')}}" data-animation-duration="3500">90%</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="progress-skill-bar">
                      ...
                      <div class="skill-bar">
                        <div class="skill-track">
                          ...
                          <div class="number-percentage-wrapper">
                            <span class="number-percentage" data-value="{{setting('site.skill')}}" data-animation-duration="3500">80%</span>
                          </div>
                        </div>
                      </div>
                    </div>
        ...
        <div class="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-eadfaad"
          ...
          <div class="elementor-widget-wrap elementor-element-populated">
            <div class="elementor-element elementor-element-44cb80c elementor-widget elementor-widget-image"
              ...
              <div class="elementor-widget-container">
                <img width="2000" height="1335" src="{{ Voyager::image($about->image) }}"
                  ...
                  <div
                    ...
                    <div class="elementor-widget-wrap elementor-element-populated">
                      <div class="elementor-element elementor-element-43603c2 elementor-widget elementor-widget-heading"
                        ...
                        <div class="elementor-widget-container">
                          <h2 class="elementor-heading-title elementor-size-default">{{ $service->title }}</h2>
                        </div>
                      </div>
                      <div
                        ...
                        <div class="elementor-widget-container">{{ $service->excerpt }}</div>
                      </div>
                      <div
                      ...
                      {{-- <div
                        class="elementor-element elementor-element-fa997d1 elementor-widget__width-initial elementor-absolute elementor-widget elementor-widget-heading"
                        data-id="fa997d1" data-element_type="widget"
                        data-settings="{&quot;_position&quot;:&quot;absolute&quot;}" data-widget_type="heading.default">
                        <div class="elementor-widget-container">
                          <h2 class="elementor-heading-title elementor-size-default">SPACEHUB
                          </h2>
                        </div>
                      </div> --}}
                    </div>
              ...
              <div class="elementor-element elementor-element-e516211 elementor-widget elementor-widget-jkit_team"
                ...
                <div class="elementor-widget-container">
                  <div class="jeg-elementor-kit jkit-team style-overlay overlay-bottom jeg_module_7_4_62bbb2f6d0c73">
                    <div class="profile-card "><img src="{{ Voyager::image($services[0]->image) }}" alt="Meeting Room"
                        style="height: 580px;">
                      <div class="hover-area alignment-bottom">
                        <div class="profile-body">
                          <h2 class="profile-title">{{ $services[0]->title }}</h2>
                          <p class="profile-designation"></p>
                          <p class="profile-content">{{ $services[0]->description }}</p>
                      ...
                      <div class="elementor-element elementor-element-ac173fc elementor-widget elementor-widget-jkit_team"
                        ...
                        <div class="elementor-widget-container">
                          <div
                            ...
                            <div class="profile-card "><img src="{{ Voyager::image($services[1]->image) }}" alt="Food &amp; Drink">
                              <div class="hover-area alignment-bottom">
                                <div class="profile-body">
                                  <h2 class="profile-title">{{ $services[1]->title }}</h2>
                                  <p class="profile-designation"></p>
                                  <p class="profile-content">{{ $services[1]->description }}</p>
                                  <ul class="social-list"></ul>
                                </div>
                              </div>
                            </div>
                      ...
                      <div class="elementor-element elementor-element-f4afff8 elementor-widget elementor-widget-jkit_team"
                        ...
                        <div class="elementor-widget-container">
                          <div
                            ...
                            <div class="profile-card "><img src="{{ Voyager::image($services[2]->image) }}" alt="Delivery">
                              <div class="hover-area alignment-bottom">
                                <div class="profile-body">
                                  <h2 class="profile-title">{{ $services[2]->title }}</h2>
                                  <p class="profile-designation"></p>
                                  <p class="profile-content">{{ $services[2]->description }}</p>
                                  <ul class="social-list"></ul>
                                </div>
                              </div>
                            </div>
                        ...
                        <div class="elementor-element elementor-element-c3e48f9 elementor-widget elementor-widget-jkit_team"
                          ...
                          <div class="elementor-widget-container">
                            <div
                              ...
                              <div class="profile-card "><img src="{{ Voyager::image($services[3]->image) }}" alt="Tea Therapy">
                                <div class="hover-area alignment-bottom">
                                  <div class="profile-body">
                                    <h2 class="profile-title">{{ $services[3]->title }}</h2>
                                    <p class="profile-designation"></p>
                                    <p class="profile-content">{{ $services[3]->description }}</p>
                                    <ul class="social-list"></ul>
                                  </div>
                                </div>
                              </div>
              ...
              <div class="elementor-element elementor-element-44c2594 elementor-widget elementor-widget-jkit_video_button"
                ...
                <div class="elementor-widget-container">
                  <div class="jeg-elementor-kit jkit-video-button jeg_module_7_8_62bbb2f6de7f5" data-autoplay="0"
                    ...
                    <a href="{{ $home_mid->link }}" class="jkit-video-popup-btn glow-enable">
            ...
            <section
              ...
              <div class="elementor-container elementor-column-gap-default">
                <div
                  ...
                  data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
                  <div class="elementor-widget-wrap elementor-element-populated"
                    style="background-image: url({{ Voyager::image($products[0]->image) }}) !important;">
                    <div class="elementor-background-overlay"></div>
                      ...
                      <div class="elementor-widget-container">
                        <div
                          ...
                          <div class="heading-section-title ">
                            <h2 class="heading-title">{{ $products[0]->title }}</h2>
                          </div>
            ...
            <section
              ...
              <div class="elementor-container elementor-column-gap-default">
                <div
                  ...
                  data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
                  <div class="elementor-widget-wrap elementor-element-populated"
                    style="background-image: url({{ Voyager::image($products[1]->image) }}) !important;">
                    <div class="elementor-background-overlay"></div>
                    ...
                    <div
                      ...
                      <div class="elementor-widget-container">
                        <div
                          ...
                          <div class="heading-section-title ">
                            <h2 class="heading-title">{{ $products[1]->title }}</h2>
                          </div>
                          <div class="heading-section-description">
                ...
                <div
                  ...
                  <div class="elementor-widget-wrap elementor-element-populated"
                    ...
                    <div
                      ...
                      <div class="elementor-widget-container">
                        <div class="elementor-button-wrapper">
                          <a href="{{ route('products.index') }}" class="elementor-button-link elementor-button elementor-size-sm"
                            role="button">
                            <span class="elementor-button-content-wrapper">
        ...
        <div class="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-81024f9"
          ...
          <div class="elementor-widget-wrap elementor-element-populated">
            ...
            <div class="elementor-element elementor-element-e9f99e6 elementor-widget elementor-widget-text-editor"
              ...
              <div class="elementor-widget-container">{{ $product->excerpt }}</div>
            </div>
                  ...
                  <div
                    ...
                    <div class="elementor-widget-wrap elementor-element-populated">
                      <div
                        ...
                        <div class="elementor-widget-container">
                          <h2 class="elementor-heading-title elementor-size-default">{{$item->title}}</h2>
                        </div>
                      </div>
                      <div
                      ...
                      <div
                        ...
                        <div class="elementor-widget-container">
                          <div
                            ...
                            <div class="heading-section-title ">
                              <h2 class="heading-title">{{ number_format($item->price, 0, '.', ',') }}₫</h2>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div
                  ...
                  <div class="elementor-widget-wrap elementor-element-populated">
                    ...
                    <div class="elementor-element elementor-element-48d7607 elementor-widget elementor-widget-heading"
                      ...
                      <div class="elementor-widget-container">
                        <h2 class="elementor-heading-title elementor-size-default">{{$report->title}}</h2>
                      </div>
                    </div>
                    <div
                ...
                <div
                  ...
                  <div class="elementor-widget-wrap elementor-element-populated">
                    <div class="elementor-element elementor-element-5c4d45f elementor-widget elementor-widget-image"
                      ...
                      <div class="elementor-widget-container">
                        <img width="497" height="497" src="{{Voyager::image($report->image)}}"
                                    ...
                                    <div class="comment-bio">
                                      <div class="bio-details">
                                        ...
                                        <span class="profile-info">
                                          <strong class="profile-name">{{$item->title}}</strong>
                                          {{-- <p class="profile-des">Students</p> --}}
                                        </span>
                                      </div>
                                    </div>
                                  </div>
    ...
    <section
      ...
      data-settings="{&quot;background_background&quot;:&quot;classic&quot;}"
      style="background-image: url({{Voyager::image(json_decode($banner_number->images)[0])}})">
      <div class="elementor-background-overlay"></div>
      <div class="elementor-container elementor-column-gap-no">
                      ...
                      <div class="elementor-widget-container">
                        <div
                          ...
                          <div class=fun-fact-inner>
                            ...
                            <div class="content">
                              <div class="number-wrapper">
                                <span class="number" data-value="{{ $item->description }}" data-animation-duration="3500">0</span>
                                +
                              </div>
                    ...
                    <div class="elementor-element elementor-element-cbb33e0 elementor-widget elementor-widget-heading"
                      ...
                      <div class="elementor-widget-container">
                        <h2 class="elementor-heading-title elementor-size-default" style="line-height: 1.8;">
                          Đăng ký nhận khuyến mãi </h2>
                      </div>
                    </div>
                    {{-- <div
                      class="elementor-element elementor-element-c74dc7a elementor-widget elementor-widget-text-editor"
                      data-id="c74dc7a" data-element_type="widget" data-widget_type="text-editor.default">
                      <div class="elementor-widget-container">
                    ...
                    <div
                      ...
                      <div class="elementor-widget-container">
                        <div class="jeg-elementor-kit jkit-mailchimp style-inline jeg_module_7_22_62bbb2f71d392">
                          <form method="post" action="{{ route('feedback') }}" class="jkit-mailchimp-form">
                            @csrf
              ...
              <div class="elementor-container elementor-column-gap-no">
                <div
                  ...
                  <div class="elementor-widget-wrap elementor-element-populated">
                    ...
                    {{-- <div
                      class="elementor-element elementor-element-a59f643 elementor-widget elementor-widget-text-editor"
                      data-id="a59f643" data-element_type="widget" data-widget_type="text-editor.default">
                      <div class="elementor-widget-container">
